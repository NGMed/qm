---
name: "source-command-stripe-explain-error"
description: "Explain Stripe error codes and provide solutions with code examples"
---

# source-command-stripe-explain-error

Use this skill when the user asks to run the migrated source command `stripe-explain-error`.
