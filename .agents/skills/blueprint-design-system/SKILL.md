...
- **Editorial Typography**: Cormorant Garamond serif for headlines, DM Sans for body
...
```
Read: .Codex/skills/blueprint-design-system/style-guide.md
```
...
- [ ] Typography uses Cormorant Garamond for headings, Inter for body
...
1. **Using generic fonts** — Always import and use Cormorant Garamond + Inter
...
- **Complete Style Guide**: `.Codex/skills/blueprint-design-system/style-guide.md`
