---
name: "source-command-vercel-bootstrap"
...
# source-command-vercel-bootstrap

Use this skill when the user asks to run the migrated source command `vercel-bootstrap`.
