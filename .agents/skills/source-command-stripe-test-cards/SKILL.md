---
name: "source-command-stripe-test-cards"
description: "Display Stripe test card numbers for various testing scenarios"
---

# source-command-stripe-test-cards

Use this skill when the user asks to run the migrated source command `stripe-test-cards`.
